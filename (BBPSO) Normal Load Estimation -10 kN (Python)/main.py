...
## Change this variable to set the number of models
...
plt.savefig('Ncap_5Mod_BBPSO_10kN.pdf', bbox_inches='tight',pad_inches=0.1)  # Save as PDF
plt.show()

# Moving average window with a 1 second window length
window_size = 2001
if window_size % 2 == 0:
...
plt.savefig('Ncap_Filtrered_5Mod_BBPSO_10kN.pdf', bbox_inches='tight',pad_inches=0.1)  # Save as PDF
plt.show()
...
plt.title('Roller Angular Velocity')
# RMRSE of the parameter estimation
